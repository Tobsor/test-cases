...
test.describe(`Bookmarks Delete a table bookmark`, () => {
  test(`Verifies that a table bookmark can be deleted correctly`, async ({ page }) => {
    ...
    await it.step(`6. Check the bookmarked table`, async () => {
      await runManualStep(page, `6. Check the bookmarked table`);
    });

    await it.step(`7. Click on \`Remove\` button in the toolbar`, async () => {
      await runManualStep(page, `7. Click on \`Remove\` button in the toolbar`);
    });
