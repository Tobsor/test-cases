...
test.describe(`Bookmarks Delete a time series bookmark`, () => {
  test(`Verifies that a time series bookmark can be deleted correctly`, async ({ page }) => {
    ...
    await it.step(`5. Check the bookmarked time series`, async () => {
      await runManualStep(page, `5. Check the bookmarked time series`);
    });

    await it.step(`6. Click on \`Remove\` button in the toolbar`, async () => {
      await runManualStep(page, `6. Click on \`Remove\` button in the toolbar`);
    });
