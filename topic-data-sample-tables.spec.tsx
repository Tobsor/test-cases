...
test.describe(`Topic Data Sample tables`, () => {
  test(`Explain what this test case is about`, async ({ page }) => {
    await it.step(`1. Go to [/topics/TOTAL_CREDIT/data](http://localhost:3000/topics/TOTAL_CREDIT/data)`, async () => {
      await runManualStep(page, `1. Go to [/topics/TOTAL_CREDIT/data](http://localhost:3000/topics/TOTAL_CREDIT/data)`);
    });

    await it.step(`3. Click on the tab "Households"`, async () => {
      await runManualStep(page, `3. Click on the tab "Households"`);
    });

    await it.step(`4. Click on the card with the code F3.1`, async () => {
      await runManualStep(page, `4. Click on the card with the code F3.1`);
    });
