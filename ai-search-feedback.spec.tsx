...
test.describe(`AI Search Feedback`, () => {
  test(`This test case should verify if the AI-Search feedback feature works as expected.`, async ({ page }) => {
    ...
    await it.step(`2. Enter the following search term and press enter: "What is the inflation rate in Switzerland?"`, async () => {
      await runManualStep(page, `2. Enter the following search term and press enter: "What is the inflation rate in Switzerland?"`);
    });

    await it.step(`3. Press on the like button`, async () => {
      await runManualStep(page, `3. Press on the like button`);
    });

    await it.step(`4. Enter the following search term press enter: "What is the inflation rate in Germany?"`, async () => {
      await runManualStep(page, `4. Enter the following search term press enter: "What is the inflation rate in Germany?"`);
    });

    await it.step(`5. Click on the dislike button`, async () => {
      await runManualStep(page, `5. Click on the dislike button`);
    });

    await it.step(`6. The following scenarios should lead to the submit button being enabled`, async () => {
      await runManualStep(page, `6. The following scenarios should lead to the submit button being enabled`);
    });

    await it.step(`7. The following scenarios should lead to the submit button being disabled`, async () => {
      await runManualStep(page, `7. The following scenarios should lead to the submit button being disabled`);
    });

    await it.step(`8. Select Incomplete and press on "Submit"`, async () => {
      await runManualStep(page, `8. Select Incomplete and press on "Submit"`);
    });
