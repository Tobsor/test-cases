...
test.describe(`Home Page Highlights`, () => {
  test(`Verifies that the Highlights section works as expected on the homepage`, async ({ page }) => {
    ...
    await it.step(`2. Scroll to the Highlights section`, async () => {
      await runManualStep(page, `2. Scroll to the Highlights section`);
    });

    await it.step(`3. Hover over the News content`, async () => {
      await runManualStep(page, `3. Hover over the News content`);
    });

    await it.step(`4. Click on the arrow-right button`, async () => {
      await runManualStep(page, `4. Click on the arrow-right button`);
    });

    await it.step(`5. Hover over the News content again`, async () => {
      await runManualStep(page, `5. Hover over the News content again`);
    });

    await it.step(`7. Click on the last navigation dots`, async () => {
      await runManualStep(page, `7. Click on the last navigation dots`);
    });

    await it.step(`8. Tab into the slide`, async () => {
      await runManualStep(page, `8. Tab into the slide`);
    });
