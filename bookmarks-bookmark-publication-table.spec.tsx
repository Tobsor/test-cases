...
test.describe(`Bookmarks Bookmark publication table`, () => {
  test(`Verifies that publication tables are correctly added to the bookmarks`, async ({ page }) => {
    await it.step(`1. Navigate to \`/topics/LBS/tables-and-dashboards\``, async () => {
      await runManualStep(page, `1. Navigate to \`/topics/LBS/tables-and-dashboards\``);
    });

    await it.step(`2. In the table section click on A1 card`, async () => {
      await runManualStep(page, `2. In the table section click on A1 card`);
    });
    ...
    await it.step(`4. Click on the tables tab button`, async () => {
      await runManualStep(page, `4. Click on the tables tab button`);
    });
