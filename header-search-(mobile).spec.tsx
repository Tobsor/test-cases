...
test.describe(`Header Search (Mobile)`, () => {
  test(`Verifies that the search in the header is usable and supports the user in finding the content he is looking for on mobile.`, async ({ page }) => {
    ...
    await it.step(`2. Click on Search button in the main navigation`, async () => {
      await runManualStep(page, `2. Click on Search button in the main navigation`);
    });

    await it.step(`3. Type Germany`, async () => {
      await runManualStep(page, `3. Type Germany`);
    });
    ...
    await it.step(`5. Repeat step 1 to 3`, async () => {
      await runManualStep(page, `5. Repeat step 1 to 3`);
    });

    await it.step(`6. Click on the first suggestion`, async () => {
      await runManualStep(page, `6. Click on the first suggestion`);
    });

    await it.step(`7. Repeat step 1 to 3`, async () => {
      await runManualStep(page, `7. Repeat step 1 to 3`);
    });

    await it.step(`8. Click on the second suggestion`, async () => {
      await runManualStep(page, `8. Click on the second suggestion`);
    });

    await it.step(`7. Repeat step 1 to 2`, async () => {
      await runManualStep(page, `7. Repeat step 1 to 2`);
    });

    await it.step(`8. Click on close menu button`, async () => {
      await runManualStep(page, `8. Click on close menu button`);
    });
