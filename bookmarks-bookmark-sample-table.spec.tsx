...
test.describe(`Bookmarks Bookmark sample table`, () => {
  test(`Verifies that sample tables are correctly added to the bookmarks`, async ({ page }) => {
    ...
    await it.step(`2. Expand the sample tables section`, async () => {
      await runManualStep(page, `2. Expand the sample tables section`);
    });

    await it.step(`3. Click on the first item card`, async () => {
      await runManualStep(page, `3. Click on the first item card`);
    });

    await it.step(`4. Click the bookmarks button in the header`, async () => {
      await runManualStep(page, `4. Click the bookmarks button in the header`);
    });

    await it.step(`5. Click on the tables tab button`, async () => {
      await runManualStep(page, `5. Click on the tables tab button`);
    });

    await it.step(`6. Close the modal by clicking on X or in the overlay`, async () => {
      await runManualStep(page, `6. Close the modal by clicking on X or in the overlay`);
    });

    await it.step(`7. Click on \`Bookmark\` button`, async () => {
      await runManualStep(page, `7. Click on \`Bookmark\` button`);
    });

    await it.step(`8. Click the bookmarks button in the header`, async () => {
      await runManualStep(page, `8. Click the bookmarks button in the header`);
    });

    await it.step(`9. Close the modal by clicking on X or in the overlay`, async () => {
      await runManualStep(page, `9. Close the modal by clicking on X or in the overlay`);
    });
