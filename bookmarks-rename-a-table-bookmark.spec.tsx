...
test.describe(`Bookmarks Rename a table bookmark`, () => {
  test(`Verifies that a table bookmark can be renamed correctly`, async ({ page }) => {
    ...
    await it.step(`2. Check the two first time series in the time series list`, async () => {
      await runManualStep(page, `2. Check the two first time series in the time series list`);
    });

    await it.step(`3. Click on table in the switch view button`, async () => {
      await runManualStep(page, `3. Click on table in the switch view button`);
    });

    await it.step(`4. Click on \`Bookmark\` button`, async () => {
      await runManualStep(page, `4. Click on \`Bookmark\` button`);
    });

    await it.step(`5. Click the bookmarks button in the header`, async () => {
      await runManualStep(page, `5. Click the bookmarks button in the header`);
    });

    await it.step(`6. Click on the rename button icon in the line of the bookmarked table`, async () => {
      await runManualStep(page, `6. Click on the rename button icon in the line of the bookmarked table`);
    });

    await it.step(`7. Remove the text`, async () => {
      await runManualStep(page, `7. Remove the text`);
    });

    await it.step(`8. Click on \`Save\` button`, async () => {
      await runManualStep(page, `8. Click on \`Save\` button`);
    });

    await it.step(`9. Add the following test in the input field: "Custom bookmark name"`, async () => {
      await runManualStep(page, `9. Add the following test in the input field: "Custom bookmark name"`);
    });

    await it.step(`10. Click on \`Save\` button`, async () => {
      await runManualStep(page, `10. Click on \`Save\` button`);
    });
