...
test.describe(`Time Series detail chart Y Axes`, () => {
  test(`When multiple time series are selected, Y-axes should be merged for time series with the same unit + unit code + unit multiplier.`, async ({ page }) => {
    await it.step(`1. Go to \`/topics/IDS/BIS,WS_DEBT_SEC2_PUB,1.0/Q.3P.1Z.1.B.C.A.A.TO1.C.A.C.A.A.G?additional_ts=BIS%2CWS_DEBT_SEC2_PUB%2C1.0%255EQ.3P.1Z.1.B.C.A.A.TO1.C.A.C.A.A.I%2CQ.3P.PE.1.K.C.A.A.USD.K.U.A.A.A.I%2CQ.3P.4W.1.G.C.A.D.TO1.K.U.C.A.A.I\``, async () => {
      await runManualStep(page, `1. Go to \`/topics/IDS/BIS,WS_DEBT_SEC2_PUB,1.0/Q.3P.1Z.1.B.C.A.A.TO1.C.A.C.A.A.G?additional_ts=BIS%2CWS_DEBT_SEC2_PUB%2C1.0%255EQ.3P.1Z.1.B.C.A.A.TO1.C.A.C.A.A.I%2CQ.3P.PE.1.K.C.A.A.USD.K.U.A.A.A.I%2CQ.3P.4W.1.G.C.A.D.TO1.K.U.C.A.A.I\``);
    });

    await it.step(`2. We see 4 different time series with the same unit + unit code + unit multiplier`, async () => {
      await runManualStep(page, `2. We see 4 different time series with the same unit + unit code + unit multiplier`);
    });

    await it.step(`3. We should only see 1 Y-Axis`, async () => {
      await runManualStep(page, `3. We should only see 1 Y-Axis`);
    });

    await it.step(`4. Go to \`/topics/IDS/BIS,WS_DEBT_SEC2_PUB,1.0/Q.3P.1Z.1.B.C.A.A.TO1.C.A.C.A.A.G?additional_ts=BIS%2CWS_DEBT_SEC2_PUB%2C1.0%255EQ.3P.1Z.1.B.C.A.A.TO1.C.A.C.A.A.I%257CBIS%2CWS_GLI%2C1.0%255EQ.JPY.JP.G.A.A.B.JPY%257CBIS%2CWS_CPMI_CT2%2C1.0%255EA.CH.U.CH2C.V.V.S\``, async () => {
      await runManualStep(page, `4. Go to \`/topics/IDS/BIS,WS_DEBT_SEC2_PUB,1.0/Q.3P.1Z.1.B.C.A.A.TO1.C.A.C.A.A.G?additional_ts=BIS%2CWS_DEBT_SEC2_PUB%2C1.0%255EQ.3P.1Z.1.B.C.A.A.TO1.C.A.C.A.A.I%257CBIS%2CWS_GLI%2C1.0%255EQ.JPY.JP.G.A.A.B.JPY%257CBIS%2CWS_CPMI_CT2%2C1.0%255EA.CH.U.CH2C.V.V.S\``);
    });

    await it.step(`5. We see 4 different time series. 2 time series have the same unit + unit code + unit multiplier.`, async () => {
      await runManualStep(page, `5. We see 4 different time series. 2 time series have the same unit + unit code + unit multiplier.`);
    });

    await it.step(`6. We should see 3 different Y-Axes`, async () => {
      await runManualStep(page, `6. We should see 3 different Y-Axes`);
    });
