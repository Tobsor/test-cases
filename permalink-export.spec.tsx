...
test.describe(`Permalink Export`, () => {
  test(`Make sure that old permalinks can still be used to trigger exports.`, async ({ page }) => {
    await it.step(`1. Open all of these URLs:`, async () => {
      await runManualStep(page, `1. Open all of these URLs:`);
    });

    await it.step(`2. https://dataportal.uat.bisinfo.org/export/ae7ab50c680579e9fed1ff771c64fced`, async () => {
      await runManualStep(page, `2. https://dataportal.uat.bisinfo.org/export/ae7ab50c680579e9fed1ff771c64fced`);
    });

    await it.step(`3. https://dataportal.uat.bisinfo.org/export/5d4afcbe252c5f6c53c40aa735e57762`, async () => {
      await runManualStep(page, `3. https://dataportal.uat.bisinfo.org/export/5d4afcbe252c5f6c53c40aa735e57762`);
    });

    await it.step(`4. https://dataportal.uat.bisinfo.org/export/d73359385fb5f8962484a4f158dde9d8`, async () => {
      await runManualStep(page, `4. https://dataportal.uat.bisinfo.org/export/d73359385fb5f8962484a4f158dde9d8`);
    });

    await it.step(`5. https://dataportal.uat.bisinfo.org/export/eeb474d2cc8c74a39899c85346e9b72b`, async () => {
      await runManualStep(page, `5. https://dataportal.uat.bisinfo.org/export/eeb474d2cc8c74a39899c85346e9b72b`);
    });
