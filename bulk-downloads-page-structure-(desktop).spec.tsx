...
test.describe(`Bulk downloads Page structure (Desktop)`, () => {
  test(`Verifies that the bulk downloads page features downloads to every topic and structures them into groups`, async ({ page }) => {
    await it.step(`1. Navigate to \`/bulkdownload\` and confirm the following:`, async () => {
      await runManualStep(page, `1. Navigate to \`/bulkdownload\` and confirm the following:`);
    });
