...
test.describe(`Bookmarks Bookmarks time series`, () => {
  test(`Verifies that time series are correctly added to the bookmarks`, async ({ page }) => {
    await it.step(`1. Navigate to \`/topics/LBS/data\``, async () => {
      await runManualStep(page, `1. Navigate to \`/topics/LBS/data\``);
    });

    await it.step(`2. Click the bookmarks button in the header`, async () => {
      await runManualStep(page, `2. Click the bookmarks button in the header`);
    });

    await it.step(`3. Close the modal by clicking on X or in the overlay`, async () => {
      await runManualStep(page, `3. Close the modal by clicking on X or in the overlay`);
    });

    await it.step(`4. Check a time series in the time series list`, async () => {
      await runManualStep(page, `4. Check a time series in the time series list`);
    });

    await it.step(`5. Click on \`Bookmark\` button`, async () => {
      await runManualStep(page, `5. Click on \`Bookmark\` button`);
    });

    await it.step(`6. Click the bookmarks button in the header`, async () => {
      await runManualStep(page, `6. Click the bookmarks button in the header`);
    });

    await it.step(`7. Close the modal by clicking on X or in the overlay`, async () => {
      await runManualStep(page, `7. Close the modal by clicking on X or in the overlay`);
    });

    await it.step(`8. Click on another time series`, async () => {
      await runManualStep(page, `8. Click on another time series`);
    });

    await it.step(`9. Repeat step 5 to 7`, async () => {
      await runManualStep(page, `9. Repeat step 5 to 7`);
    });

    await it.step(`10. Click on \`Bookmark\` button again`, async () => {
      await runManualStep(page, `10. Click on \`Bookmark\` button again`);
    });

    await it.step(`11. Navigate to \`/topics/LBS/data\``, async () => {
      await runManualStep(page, `11. Navigate to \`/topics/LBS/data\``);
    });

    await it.step(`12. Check 3 time series (one which is already bookmarked, two which are not bookmarked yet)`, async () => {
      await runManualStep(page, `12. Check 3 time series (one which is already bookmarked, two which are not bookmarked yet)`);
    });

    await it.step(`13. Click on \`Bookmark\` button`, async () => {
      await runManualStep(page, `13. Click on \`Bookmark\` button`);
    });

    await it.step(`14. Repeat step 6`, async () => {
      await runManualStep(page, `14. Repeat step 6`);
    });
