...
test.describe(`Bookmarks Rename a time series bookmark`, () => {
  test(`Verifies that a time series bookmark can be renamed correctly`, async ({ page }) => {
    ...
    await it.step(`2. Check the first time series in the time series list`, async () => {
      await runManualStep(page, `2. Check the first time series in the time series list`);
    });

    await it.step(`3. Click on \`Bookmark\` button`, async () => {
      await runManualStep(page, `3. Click on \`Bookmark\` button`);
    });
    ...
    await it.step(`5. Click on the 3 dots icon button in the line of the bookmarked time series`, async () => {
      await runManualStep(page, `5. Click on the 3 dots icon button in the line of the bookmarked time series`);
    });

    await it.step(`6. Click on \`Rename\` link`, async () => {
      await runManualStep(page, `6. Click on \`Rename\` link`);
    });
    ...
    await it.step(`9. Add the following text in the input field: "Custom bookmark name"`, async () => {
      await runManualStep(page, `9. Add the following text in the input field: "Custom bookmark name"`);
    });
