...
test.describe(`AI Search Standard Search`, () => {
  test(`This test case should verify that the standard use case of the AI search feature works as expected.`, async ({ page }) => {
    ...
    await it.step(`2. Insert the following text into the search field "What is the inflation rate of Switzerland?"`, async () => {
      await runManualStep(page, `2. Insert the following text into the search field "What is the inflation rate of Switzerland?"`);
    });

    await it.step(`3. Make sure that the Toggle with the label "Include AI-assisted results" is enabled`, async () => {
      await runManualStep(page, `3. Make sure that the Toggle with the label "Include AI-assisted results" is enabled`);
    });

    await it.step(`3. Press Enter`, async () => {
      await runManualStep(page, `3. Press Enter`);
    });

    await it.step(`4. Highlighting the question mark items`, async () => {
      await runManualStep(page, `4. Highlighting the question mark items`);
    });

    await it.step(`5. Click on the button "Show reasoning"`, async () => {
      await runManualStep(page, `5. Click on the button "Show reasoning"`);
    });

    await it.step(`6. Click on each tab`, async () => {
      await runManualStep(page, `6. Click on each tab`);
    });

    await it.step(`7. Close the modal`, async () => {
      await runManualStep(page, `7. Close the modal`);
    });

    await it.step(`8. Click on the first link`, async () => {
      await runManualStep(page, `8. Click on the first link`);
    });

    await it.step(`9. Open the search by clicking the search button in the header`, async () => {
      await runManualStep(page, `9. Open the search by clicking the search button in the header`);
    });

    await it.step(`10. Enter the term "What is the inflation rate of Switzerland?" and press enter`, async () => {
      await runManualStep(page, `10. Enter the term "What is the inflation rate of Switzerland?" and press enter`);
    });

    await it.step(`11. Return to \`/\``, async () => {
      await runManualStep(page, `11. Return to \`/\``);
    });

    await it.step(`12. Enter the term "What is the inflation rate of Switzerland?" and press enter`, async () => {
      await runManualStep(page, `12. Enter the term "What is the inflation rate of Switzerland?" and press enter`);
    });
    ...
    await it.step(`14. Disable the AI-Search Toggle- The right hand side label "Includes AI-refined results" should disappear`, async () => {
      await runManualStep(page, `14. Disable the AI-Search Toggle- The right hand side label "Includes AI-refined results" should disappear`);
    });
    ...
    await it.step(`15. Enter the term "What is the inflation rate of Switzerland?" and press enter- The user again should be redirected to \`/search\``, async () => {
      await runManualStep(page, `15. Enter the term "What is the inflation rate of Switzerland?" and press enter- The user again should be redirected to \`/search\``);
    });
