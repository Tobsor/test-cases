...
test.describe(`AI Search Prompt Moderation`, () => {
  test(`This test case verifies that the prompt moderation works and that the frontend handles the different scenarios correctly.`, async ({ page }) => {
    ...
    await it.step(`2. Verify that the AI-Toggle is enabled or enable it if it wasn't`, async () => {
      await runManualStep(page, `2. Verify that the AI-Toggle is enabled or enable it if it wasn't`);
    });

    await it.step(`4. Enter the term "Who is Mickey Mouse?"`, async () => {
      await runManualStep(page, `4. Enter the term "Who is Mickey Mouse?"`);
    });

    await it.step(`5. Enter the term "How bad is the inflation in Switzerland?"`, async () => {
      await runManualStep(page, `5. Enter the term "How bad is the inflation in Switzerland?"`);
    });
