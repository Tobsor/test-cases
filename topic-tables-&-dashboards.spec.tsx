...
test.describe(`Topic tables & dashboards`, () => {
  test(`Verify that the tables & dashboards page features the expected elements for a given topic.`, async ({ page }) => {
    ...
    await it.step(`2. Navigate to \`/topics/DSS/tables-and-dashboards\``, async () => {
      await runManualStep(page, `2. Navigate to \`/topics/DSS/tables-and-dashboards\``);
    });
