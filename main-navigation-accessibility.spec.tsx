...
test.describe(`Main Navigation Accessibility`, () => {
  test(`Verifies that the main navigation is accessible by keyboard.`, async ({ page }) => {
    await it.step(`1. Go to \`/\``, async () => {
      await runManualStep(page, `1. Go to \`/\``);
    });

    await it.step(`2. Press Tab 3 times`, async () => {
      await runManualStep(page, `2. Press Tab 3 times`);
    });
    ...
    await it.step(`4. Press Enter`, async () => {
      await runManualStep(page, `4. Press Enter`);
    });

    await it.step(`5. Press Enter`, async () => {
      await runManualStep(page, `5. Press Enter`);
    });

    await it.step(`6. Press Tab`, async () => {
      await runManualStep(page, `6. Press Tab`);
    });

    await it.step(`7. Press Tab`, async () => {
      await runManualStep(page, `7. Press Tab`);
    });

    await it.step(`8. Press Tab`, async () => {
      await runManualStep(page, `8. Press Tab`);
    });

    await it.step(`9. Press Tab 3 times`, async () => {
      await runManualStep(page, `9. Press Tab 3 times`);
    });

    await it.step(`10. Press "Arrow Down"-Key`, async () => {
      await runManualStep(page, `10. Press "Arrow Down"-Key`);
    });
